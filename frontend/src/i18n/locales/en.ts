export default {
  monitor: {
    ...
    "popupFallback": "Open in a new tab",
    "fullscreenUnavailable": "Full screen is unavailable. You can maximize this window.",
    "sorts": {
    ...
    "states": {
      ...
      "warning": "Warning",
      "paused": "Print paused",
      "plate": "Clear the plate",
      "queuePaused": "Queue paused",
      "queueError": "Check the queue",
      "filament": "Material needed",
      "manual": "Manual start needed",
      "dispatchFailed": "Preparation failed",
      "storageFull": "Storage full",
      "lost": "Connection lost during work",
      "printing": "Printing",
      "preparing": "Preparing",
      "heating": "Heating",
      "uploading": "Uploading",
      ...
      "scheduled": "Scheduled",
      "stagger": "Waiting for a start slot",
      "drying": "Drying",
      "waiting": "Waiting",
      "finished": "Finished",
    ...
    "waits": {
      ...
      "plate_not_cleared": "Plate not cleared",
      "drying": "Waiting for drying",
      "scheduled": "Scheduled start",
      "manual_start": "Manual start needed",
      "stagger": "Waiting for a start slot",
      "filament_unavailable": "Check the material and feed configuration",
      "dispatch_failed": "Preparation failed",
      "storage_full": "Timelapse storage is full",
      "unknown": "Waiting for a check"
    },
    "pauses": {
      "user": "Paused by operator",
      "filament_runout": "Filament ran out",
      "door_open": "Door or cover open",
      "presence_check": "Presence check required",
      "file_pause_command": "Pause in the print file",
      "ai_first_layer_defect": "First layer issue",
      "ai_spaghetti": "Possible print failure",
      "foreign_object": "Foreign object on plate",
      "plate_objects": "Objects detected on plate",
      "hms_other": "Printer warning",
      "unknown": "Check the printer"
    },
    "clearTarget": "Printer #{{id}} from monitor · Show all",
    "temperatures": {
      "nozzle_2": "Second nozzle",
      "nozzle_2_target": "Second nozzle target",
      "bed": "Bed",
      "bed_target": "Bed target",
      "nozzle": "Nozzle",
      "nozzle_target": "Nozzle target",
      "nozzle_0": "Left nozzle",
      "nozzle_0_target": "Left nozzle target",
      "nozzle_1": "Right nozzle",
      "nozzle_1_target": "Right nozzle target",
      "chamber": "Chamber",
    ...
    "jobEta": "Job remaining",
    "queueEta": "Queue remaining",
    "progress": "Progress",
    "uploadProgress": "Upload progress",
    "queueEmpty": "Queue empty",
    "pending": "pending",
    "queuePausedShort": "Queue paused",
    "autoQueueOff": "AutoQueue excluded",
    "autoQueue": "Automatic allocation",
    "printerState": "Printer",
    "queueEnabled": "Queue enabled",
    "layers": "Layer",
    "unknownDurations": "Jobs without an estimate",
    "waitReason": "Waiting for",
    "pauseReason": "Pause reason",
    "scheduledAt": "Scheduled for",
    "telemetryAt": "Last printer message",
    "activeHms": "Active printer messages",
    "severity": "Severity {{value}}",
    "openPrinter": "Open printer",
    "openQueue": "Open queue",
    "loading": "Loading the farm…",
    "serverUpdated": "Server updated at {{time}}",
    "stale": "Data is stale",
    "reconnecting": "Reconnecting…",
    "waitingUpdateShort": "Updating…",
    "forecastUnavailable": "Queue estimate unavailable or out of date",
    "orderHeld": "Order held while interacting",
    "tokenInvalid": "TV access is invalid or expired",
    "tokenHelp": "Create a new Status monitor token in Settings → API Keys, then open its TV link.",
    "accessDenied": "This view is unavailable",
    "accessHelp": "Sign in with an account that can read these printers and queues, then reload the monitor.",
    "signInRequired": "Sign in to continue",
    "signIn": "Open sign in",
    "retry": "Refresh",
    "connectionFailed": "Cannot load the farm",
    "empty": "No printers in this farm yet",
    "noResults": "No printers match this search",
    "noAttention": "No printers need attention",
    "noTag": "No tag",
    "noLocation": "No location",
    "visible": "On screen: {{count}} / {{total}}",
    "scrollHint": "Scroll to see the rest",
    "tokenScope": "Status monitor",
    "tokenDescription": "Read-only access to all printers and both monitor views: names of printers, locations, states, queue counts and estimates. No job or file names, cameras or controls.",
    "tvPrivacy": "TV view shows operational data only. Job names and controls are unavailable.",
    "copyTvLink": "Copy TV link",
    "tokenPermissionDenied": "You do not have permission to issue this monitor access."
  },
  filamentRouting: {
  ...
  autoQueue: {
    ...
    sourceFailed: 'File error',
    retry: 'Retry',
    retryQueued: 'File checked; job returned to the queue',
    ...
    rebalance: {
      action: 'Rebalance',
      moved: 'Moved {{parts}} parts: {{converted}} prints re-targeted, {{created}} added',
      nothing: 'Nothing would finish sooner on another model',
      movedFrom: 'Moved here from {{model}} at {{when}}',
      skipped: {
        not_found: 'This item no longer exists',
        already_assigned: 'Already handed to a printer',
        not_filed: 'Not filed under an order line — nothing to rebalance it against',
        pinned: 'Pinned to specific filament slots — not moved',
        ...
        cooldown: 'This line was rebalanced a moment ago',
      },
    },
  ...
  settings: {
    ...
    slowQueryMs: 'Slow query log',
    slowQueryMsDescription: 'Log a warning for any database statement slower than this. 0 turns it off. The log records the statement text only — never the values bound to it.',
    slowRequestMs: 'Slow request log',
    slowRequestMsDescription: 'Log a warning for any API request slower than this, with how many database statements it ran and how long they took. 0 turns it off.',
    ...
    staggerConcurrentPerGroupDescription: 'Max printers heating at the same time within one group — a phase, a room, or both. A group can override this below.',
    ...
    staggerGroupLimitFor: 'Limit for {{name}}',
  ...
  login: {
    ...
    forgotPasswordAskAdmin: 'Forgot your password? Ask your administrator to reset it.',
  ...
  orders: {
    ...
    fromFiles: {
      title: 'Plan from files',
      stepParts: 'Parts',
      stepPlan: 'Plan',
      name: 'Order name',
      useProduct: 'Use product “{{name}}”',
      units: 'Units',
      kit: 'One unit is:',
      targets: 'Target per part',
      part: 'Part',
      ...
      cancel: 'Cancel',
      close: 'Close',
      hoursNote: 'Hours are machine-hours, not time to completion.',
      created: 'Order created',
      queued: 'Queued',
      openOrder: 'Open order',
      noTargets: 'Set a target for at least one part',
      loadFailed: 'Could not read the files',
    },
  },
  ...
  orderFiling: {
    ...
    newOrder: 'New order for this batch',
  ...
  stock: {
    ...
    page: {
      title: 'Stock',
      intro: 'What is on the shelf across every product, which orders hold kits in reserve, and every movement that got it there.',
      search: 'Search products…',
      onlyWithStock: 'Only with stock',
      empty: 'Nothing on any shelf yet.',
      emptyFiltered: 'No product matches.',
      product: 'Product',
      kits: 'Kits',
      partsColumn: 'Parts',
      ...
      oneOff: 'one-off',
      reservations: 'Reserved by orders',
      noReservations: 'No active order holds kits of this product.',
      journal: 'Movements',
      filterProduct: 'Product',
      anyProduct: 'Any product',
      filterReason: 'Reason',
      anyReason: 'Any reason',
      loadOlder: 'Show older',
      wholeLedger: 'That is the whole ledger.',
  ...
  system: {
    ...
    poolOverflow: '{{n}} overflow',
    cacheHitRatio: 'Cache hit ratio',
    deadlocks: '{{n}} deadlocks',
    journalMode: 'Journal mode',
    walSize: 'WAL {{size}}',
    slowestStatements: 'Slowest statements',
    largestTables: 'Largest tables',
    table: 'Table',
    tableSize: 'Size',
    tableRows: 'Rows',
    tableScans: 'Seq / index scans',
    tableScansHint: 'A large table read mostly by sequential scans is the shape that wants an index.',
    statement: 'Statement',
    calls: 'Calls',
    totalMs: 'Total',
    meanMs: 'Mean',
    noSlowStatements: 'Nothing over the threshold yet.',
    probesFailed: 'Could not read: {{list}}',
    dbMode: {
      sqlite: 'SQLite',
      embedded: 'Bundled PostgreSQL, run by BamDude',
      embedded_service: 'Bundled PostgreSQL, run as a service',
  ...
  cameraTokens: {
    title: 'Camera and monitor tokens',
    description:
      'Long-lived tokens for cameras and status monitors. Pick what each token may reach; every token can be revoked at any time.',
    scope: {
