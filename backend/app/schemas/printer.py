...
class PrinterStatus(BaseModel):
    ...
    door_open: bool = False  # Enclosure door open (X1/X1C/X1E via home_flag, X2D via stat; bit 23)
    ...
    # Whether the source 3MF supports per-object skipping (gcode_label_objects
    ...
    # supports_drying is False on these; the UI keeps the control visible but
    # disabled and says why, rather than dropping it without explanation.
